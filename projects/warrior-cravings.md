...
layout: project
type: project
image: images/ProjectImages/WarriorCravings/wc-logo.png
...
#### The Following Screenshots are pages that I have helped developed, fixed, rewrote, and reworked.

<div class="ui center container">
    <img width="700vw" src="../images/ProjectImages/WarriorCravings/landing-page-new.png" alt="landing page from Deployed Site"/>
    <img width="700vw" src="../images/ProjectImages/WarriorCravings/user-vendors-list.PNG" alt="vendor list from Deployed Site"/>
    <img width="700vw" src="../images/ProjectImages/WarriorCravings/vendor-menuitems.png" alt="vendor items from Deployed Site"/>
    <img width="700vw" src="../images/ProjectImages/WarriorCravings/add-vendor.PNG" alt="admin vendor list from Deployed Site"/>
    <img width="700vw" src="../images/ProjectImages/WarriorCravings/final-location.PNG" alt="location from Deployed Site"/>
    <img width="700vw" src="../images/ProjectImages/WarriorCravings/vendor-myvendor.png" alt="my vendor profile from Deployed Site"/>
    <img width="700vw" src="../images/ProjectImages/WarriorCravings/user-feeling-hungry.PNG" alt="feeling hungry from Deployed Site"/>
    <img width="700vw" src="../images/ProjectImages/WarriorCravings/add-menu-item.PNG" alt="admin menu item list from Deployed Site"/>
</div>
